...
public class ConvertSugar {
    ...
    /**
     * Convert structure data type "sugar" to "FragmentTree".
     *
     * @param su
     *            the su
     * @return the frag node
     */
    public FragNode convert(Sugar su) {
        ...
        try {
            ...
            /*
             * SugarNode-->FragmentTree FragmentTree2 considered the cz ions
             */
            MyTimer.showTime("\t before FragmentTree2");
...
//            FragmentTree2.outPrint(big_node);
     ...
     * SugarNode:@NodeMass,@NodeType,@NodeLevel,@NodeId prepare for fragment
     * tree build
     */
    ...
    /*
     * NormalizeTree: for delete Sub node,and add sub node mass to their parent
     * node mass
     * 
     */
