...
public class DataFilter {
    public static Peak[] experiSpPeakFiltMaxSumIntens(Peak[] expIonArray,
    ...
    public static Peak[] experiSpPeakFiltMinSinglePeak(Peak[] expIonArray,
    ...
    public static Peak[] experiSpPeakFiltMinSinglePeak(ArrayList<Peak> expIonArray,
            double filtRelateRatio) {
        Peak[] filtedIonArray;
    ...
    public static Peak[] experiSpPeakFiltMinSinglePeakIntens(Peak[] expIonArray,
            double minIntens) {
        Peak[] filtedIonArray;
        ArrayList<Peak> filtedPointList = new ArrayList<Peak>();        
    ...
    public static Peak[] experiSpPeakFiltIntensTopRank(Peak[] expIonArray,
            int topM) {
        Peak[] filtedIonArray;
        ArrayList<Peak> dataPointList = new ArrayList<Peak>();
        ArrayList<Peak> filtedPointList = new ArrayList<Peak>();
