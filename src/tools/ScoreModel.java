...
//            System.out.println("Prob. :"+normalizedScore);
     ...
     */
    public static ArrayList<PeakInfo> theroExpSpMatch(ArrayList<FragNode> theorSpList,Peak[] expSpData,double WIN)
    {
...
//                System.out.println("theor:"+theorMz);
    ...
    public static ArrayList<PeakInfo> theroExpSpMatch2(ArrayList<FragNode> theorSpList,Peak[] expSpData,double WIN)
    {
...
//                probScoreList.add(tmpInfo.probScore);
     ...
     * 
     */
    public static ArrayList<CompareInfo> scoreD(ArrayList<ArrayList<FragNode>> candiSpList,Peak[] expSpData,double[] preScoreArray,double WIN)
    {
        ArrayList<CompareInfo> candiSpMatchList=new ArrayList<CompareInfo>();
        double sumScore=0;
        for(int i=0;i<candiSpList.size();i++)
