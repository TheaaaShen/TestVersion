...
public class FetchFeature6 {
    ...
    public ArrayList<PeakEntropyInfo> FetchMatchMzPeak2(
        ...
        Hashtable<Peak, ArrayList<Integer>> peakIDHash = new Hashtable<Peak, ArrayList<Integer>>();
     ...
     */
    public PeakEntropyInfo countProbScore(Peak comPeak,ArrayList<Integer> candiIDList,ArrayList<CompareInfo> candiCompareInfoList,double[] preProbArray,int cutTime)
    {
