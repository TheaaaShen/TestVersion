...
//		for(FragNode iterStruc:candiStrucList)
	...
	public DataPoint[] spectrumFilter(DataPoint[] expIonArray, double filterRatio)
	{
		...
		DataPoint[] filteredExpIonArray=DataFilter.experiSpPeakFiltMinSinglePeakIntens(expIonArray, filtIntens);
	...
	public ArrayList<PeakEntropyInfo> coutNextStagePeak(DataPoint[] expIonArray,ArrayList<CompareInfo> scoreList,int cutTime,int peakLevel)
	{
	...
	{
		DataPoint[] expSPArray=iterSP.getPeakArray();
